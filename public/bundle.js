...
const { fotos: fotos$1 } = dataFotos;

var dataCategory = {
	categorias: [
		{ id: 'america', nombre: 'America', numeroFotos: fotos$1['america'].length, imagenPortada: './img/america.jpg' },
		{ id: 'europa', nombre: 'Europa', numeroFotos: fotos$1['europa'].length, imagenPortada: './img/europa.jpg' },
		{ id: 'africa', nombre: 'África', numeroFotos: fotos$1['africa'].length, imagenPortada: './img/africa.jpg' },
		{ id: 'asia', nombre: 'Asia', numeroFotos: fotos$1['asia'].length, imagenPortada: './img/asia.jpg' },
		{ id: 'oceania', nombre: 'Oceania', numeroFotos: fotos$1['oceania'].length, imagenPortada: './img/oceania.jpg' },
		{ id: 'antartida', nombre: 'Antártida', numeroFotos: fotos$1['antartida'].length, imagenPortada: './img/antartida.jpg',},
	],
};
...
const containerCategory$1=document.querySelector('.category--container');
...
const getValueCategory = (category) => {
    ...
    containerCategory$1.appendChild(aElementCategory);
...
const getIndexSmallGallery = (even)=>{
    if (even.target && even.target.tagName === 'IMG') {
        ...
        console.log('no me funciona el fucking else');
    }
};
